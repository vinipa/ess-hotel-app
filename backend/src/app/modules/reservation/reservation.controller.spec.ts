...
describe('ReservationController', () => {
    ...
    const mockedReservationConnectionRepository = new MockedReservationConnectionRepository();
    const mockedFavoritesRepository = new MockedFavoritesRepository();
    const mockedMailService = new MockedMailService({} as unknown as MailerService);
    ...
    describe('Default user routes', () => {
        ...
        it("showed works without error", async () => {
            ...
            await expect(controller.acceptReservation(expectData)).resolves.not.toThrow();
        })
        ...
        it("deve conseguir criar uma reserva sem erro", async () => {
            ...
            await expect(controller.makeUserReservation(expectData)).resolves.not.toThrow();
        })
